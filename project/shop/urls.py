...
from .views import (
    home, product_list, product_detail, add_to_cart, remove_from_cart, view_cart, update_cart, checkout, order_confirmation, submit_review, register_view, CustomLoginView, 
